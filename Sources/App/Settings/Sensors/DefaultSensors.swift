...
struct DefaultSensors {
    static let defaultSensors: [IoTSensor] = [
        ...
        IoTSensor(id: UUID(), name: "Device Token", iconName: "bell", value: "", isEnabled: true, deviceClass: "deviceToken", iobrokerClass: "device_token", type: "string"),
        IoTSensor(id: UUID(), name: "Luftdruck", iconName: "tornado", value: "", isEnabled: true, deviceClass: "pressure", iobrokerClass: "sensors.pressure", type: "number", unit: "hPa"),
        IoTSensor(id: UUID(), name: "Bildschirmhelligkeit", iconName: "sun.max", value: "", isEnabled: true, deviceClass: "screenBrightness", iobrokerClass: "sensors.screen_brightness", type: "number"),
        IoTSensor(id: UUID(), name: "Gerätemodell", iconName: "iphone", value: "", isEnabled: true, deviceClass: "deviceModel", iobrokerClass: "sensors.device_model", type: "string"),
        IoTSensor(id: UUID(), name: "Betriebssystemversion", iconName: "gear", value: "", isEnabled: true, deviceClass: "systemVersion", iobrokerClass: "sensors.system_version", type: "string")
    ]

    static func toCreateDeviceSensors() -> [[String: Any]] {
        return defaultSensors.map { sensor in
            var sensorDict: [String: Any] = ["id": sensor.iobrokerClass ?? "", "name": sensor.name, "type": sensor.type]
